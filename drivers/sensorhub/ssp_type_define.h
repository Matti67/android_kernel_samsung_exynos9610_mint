...
#define SENSOR_TYPE_POCKET_MODE_LEGACY                   (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 12)
#define SENSOR_TYPE_POCKET_MODE_LITE                     (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 13)
#define SENSOR_TYPE_PROXIMITY_CALIBRATION           (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 14)
#define SENSOR_TYPE_MAX                             (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 15)
